...
const EditJobPage = ({ updateJob }) => {
  ...
  const [job, setJob] = useState({
    ...
    company: {
      name: loadedjob.company.name,
      description: loadedjob.company.description,
      contactEmail: loadedjob.company.contactEmail,
      contactPhone: loadedjob.company.contactPhone,
    },
  });
